...
##################################################################
                ...
                hailo_link="https://github.com/hailo-ai/hailort-drivers/archive/refs/tags/v4.20.0.zip"
                hailo_zip="hailort-driver-${NEPI_HAILO_SW_VERSION}.zip"
                # CHECK VERSION: nepihost@device1:~/hailo/hailort-4.20.0$ hailortcli fw-control identify
                ...
                hailo_driver_folder="hailort-driver-${NEPI_HAILO_SW_VERSION}"
                install_dir="${build_folder}/${hailo_driver_folder}"
