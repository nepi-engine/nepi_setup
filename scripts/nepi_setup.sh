...
echo "NEPI MANAGES SERVICES ${SERVICES_MANAGED}"
    ...
    NEPI_MANAGES_HOSTNAME=$SERVICES_MANAGED #$(( SERVICES_MANAGED & NEPI_MANAGES_NETWORK ))
    ...
    NEPI_MANAGES_HOSTNAME=$SERVICES_MANAGED #$(( SERVICES_MANAGED & NEPI_MANAGES_DOCKER ))
