...
echo "NEPI MANAGES SERVICES ${SERVICES_MANAGED}"
    ...
    NEPI_MANAGES_NETWORK=$(( SERVICES_MANAGED & NEPI_MANAGES_NETWORK ))
    ...
    NEPI_MANAGES_DOCKER=$(( SERVICES_MANAGED & NEPI_MANAGES_DOCKER ))
